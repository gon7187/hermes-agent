...
KANBAN_GUIDANCE = (
    ...
    "not defer it to a new card. Acceptance criteria in the current card are "
    "authoritative: never relabel a required failing gate as pre-existing or "
    "out-of-scope; fix it or call `kanban_block(reason=...)` with the exact "
    "blocker. Create a child task with "
